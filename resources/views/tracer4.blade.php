    ...
    <style>
        ...
        <script>
            function validateForm() {
                var namaPerguruan = document.getElementById('namaPerguruan').value;
                var prodi = document.getElementById('prodi').value;
                var dateInput = document.getElementById('dateInput').value;

                if (namaPerguruan.trim() === "") {
                    alert("Lengkapi Nama Perguruan Tinggi");
                    return false;
                }
                if (prodi.trim() === "") {
                    alert("Lengkapi Program Studi");
                    return false;
                }

                if (dateInput === "") {
                    alert("Silahkan Isi Tanggal Diterima");
                    return false;
                }
            ...
            <div class="">
                <div class="border border-2 border-black bg-white rounded mt-5" style="height: 65%;width:50rem ">
                    ...
                    <div>
                        ...
                        <div class="mb-3 mx-5">
                            <label for="namaPerguruan" class="form-label">Nama Perguruan Tinggi</label>
                            <input type="text" class="form-control" id="namaPerguruan" placeholder="Ketik disini" style="width:380px">
                        </div>
                        <div class="mb-3 mx-5">
                            <label for="prodi" class="form-label">Program Studi</label>
                            <input type="text" class="form-control" id="prodi" placeholder="Ketik disini" style="width:250px">
                        </div>
                        <div class="mb-3 mx-5">
                            <label for="tgl" class="form-label">Tanggal Diterima</label>
                            <div>
                                <input type="date" id="dateInput" class="form-control" style="width:170px">
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="modal-body d-flex justify-content-center">
                <img src="{{asset('badge_college.png')}}" alt="" width="150px"height="150px" >
            </div>
            <div class="d-flex justify-content-center">
                <p>Kamu mendapatkan ”Badge Perguruan Tinggi”</p>
            </div>
            <div class="modal-footer justify-content-center">
                <a type="submit" class="btn btn-outline-success btn-lg btnColor"style="padding:5px 100px" href="/tracerCollege">OK</a>
            </div>
          </div>
        </div>
      </div>
