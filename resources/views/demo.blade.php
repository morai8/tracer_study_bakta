...
<body style="background-color:#94C5FF">
    ...
    <div class="container col-lg-10 d-flex justify-content-center mb-4" style="height:100%;width:70%">
                    ...
                    <div>
                        ...
                        <div class="mx-5 my-5 d-flex">
                            <div class="ms-auto">
                                ...
                                <button type="button" class=" btn btn-success btnColor text-black"onclick="validateForm()">Selanjutnya</button>
                            </div>
                            <div>
                        </div>
                    </div>
    ...
    <div class="modal fade" style="max-height: 55vh;"  id="exampleModal" tabindex="-2" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="d-flex justify-content-center">
                <p>Kamu mendapatkan ”Lencana Identitas Diri”</p>
            </div>
