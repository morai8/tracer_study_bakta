...
<head>
    ...
    function validateForm() {
        ...
        if (checkboxes.length === 0) {
            alert("Pilih setidaknya satu pilihan pada checkbox");
            return false;
        }
        var dariAspek = document.getElementById('dariAspek').value;


        if (dariAspek.trim() === "") {
            alert("Lengkapi Jawaban Kamu");
            return false;
        }
            ...
            <div class="">
                <div class="border border-2 border-black bg-white rounded mt-5" style="height: 65%;width:50rem ">
                    ...
                    <div>
                        ...
                        <div class="mb-3 mx-5">
                            <label for="berpikir" class="form-label">Berpikir tentang pekerjaan masa depan, apa yang paling menggambarkan aspirasi utama kamu?</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                                <label class="form-check-label" for="defaultCheck1">
                                    Untuk menciptakan dampak dengan bekerja di perusahaan
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                                <label class="form-check-label" for="defaultCheck1">
                                    Bekerja di perusahaan manapun yang mengikuti minat / passion pribadi
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                                <label class="form-check-label" for="defaultCheck1">
                                    Untuk memulai / mengembangkan bisnis
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                        ...
                        <div class="mb-3 mx-5">
                            <label for="dariAspek" class="form-label">Dari aspek karier, bagaimana kamu melihat dirimu dalam waktu 1-3 tahun ke depan? Tuliskan harapanmu</label>
                            <input type="text" class="form-control" id="dariAspek" placeholder="Ketik disini">
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="modal-body d-flex justify-content-center">
                <img src="{{asset('badge_harapan.png')}}" alt="" width="150px"height="150px" >
            </div>
            <div class="d-flex justify-content-center">
                <p>Kamu mendapatkan ”Badge Harapan”</p>
            </div>
            <div class="modal-footer justify-content-center">
                <a type="submit" class="btn btn-outline-success btn-lg btnColor"style="padding:5px 100px" href="/tracerHope">OK</a>
            </div>
          </div>
        </div>
      </div>
