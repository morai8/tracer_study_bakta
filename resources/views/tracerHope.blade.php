                    ...
                    <div>
                        ...
                        <div class="mx-5 my-5 d-flex">
                            <div class="ms-auto">
                                ...
                                style="width:100px" href="tracer5">Kembali</a>
    ...
    <div class="ms-auto pt-5 pr-3 ">
        <div class="card ml-3 mb-3 border-black " style="width:300px;">
            ...
            <div class="card-body">
                ...
                <img src="{{asset('badge_harapan.png')}}" alt="" width="50px"height="50px"class="mx-2">
            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" class="btn btn-outline-success btn-lg btnColor"style="padding:5px 100px" href="/tracerHopeFinal">OK</a>
            </div>
          </div>
        </div>
      </div>
